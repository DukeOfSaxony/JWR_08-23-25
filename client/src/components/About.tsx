  ...
  return (
    <section id="about" ref={sectionRef} className="py-16 md:py-24 bg-[#013823]">
      <div className="container mx-auto px-4">
        ...
        <p className="font-body text-white mb-8 slide-from-left stagger-delay-1 max-w-4xl mx-auto text-center">
        ...
        <div className="mb-12 slide-from-left stagger-delay-2">
          <img 
            src={storefrontMain} 
        ...
        <div className="max-w-4xl mx-auto">
          <h3 className="font-heading font-semibold text-2xl text-[#8c6f25] mb-4 slide-from-left stagger-delay-3 uppercase">
            Our Journey
          </h3>
          
          <p className="font-body text-white mb-6 slide-from-left stagger-delay-4">
          ...
          <h3 className="font-heading font-semibold text-2xl text-[#8c6f25] mb-4 slide-from-left stagger-delay-5 uppercase">
            What Sets Us Apart
          </h3>
          
          <ul className="space-y-4 mb-6 slide-from-left stagger-delay-6">
          ...
          <h3 className="font-heading font-semibold text-2xl text-[#8c6f25] mb-4 slide-from-left stagger-delay-7 uppercase">
            Our Promise to You
          </h3>
